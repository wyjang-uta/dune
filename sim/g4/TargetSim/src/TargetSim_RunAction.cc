...
TargetSim_RunAction::TargetSim_RunAction()
: G4UserRunAction()
{
}
...
void TargetSim_RunAction::BeginOfRunAction(const G4Run*)
{ 
  ...
  analysisManager->CreateNtupleSColumn("pid");      // pid of produced secondary particle
  analysisManager->CreateNtupleSColumn("trackPID"); // pid of track
  analysisManager->FinishNtuple();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void TargetSim_RunAction::EndOfRunAction(const G4Run* /*run*/)
{
  // Print
  //
  if (IsMaster()) {
